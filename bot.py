...
def farsi_brief(cluster: StoryCluster) -> str:
    ...
    if re.search(r"fake|fraud|scam|warn|booking|کلاهبرداری|احتيال|مزيف", text, re.I):
        ...
        context = "این یک خبر مثبت محلی درباره امانت داری، رفتار انسانی و بازگرداندن پول یا اموال در دبی است."
        angle = "برای کپشن، حس خوب شهر، اعتماد عمومی و واکنش پلیس یا مردم برجسته شود."
    elif re.search(r"solidarity|condolence|condemns|foreign|minister|تعزي|تتضامن|يدين", text, re.I):
        context = "امارات درباره یک اتفاق بین المللی پیام همبستگی، تسلیت یا موضع رسمی اعلام کرده است."
        angle = "برای کپشن، پیام انسانی و نقش دیپلماسی امارات در منطقه یا جهان ساده توضیح داده شود."
    elif "crime" in tags:
        context = "این خبر با پلیس، دادگاه، امنیت عمومی، کلاهبرداری یا هشدارهای مهم برای مردم مرتبط است."
        angle = "برای کپشن، اول اثر مستقیم روی ساکنان و بعد نکته احتیاطی یا قانونی نوشته شود."
    elif "rules" in tags:
        context = "این خبر درباره قانون، ویزا، جریمه، مجوز، پارکینگ، سالک یا خدمات شهری در امارات است."
        angle = "برای کپشن، خیلی روشن بگویید چه چیزی تغییر کرده و چه کسانی باید حواسشان باشد."
    elif "weather/traffic" in tags:
        context = "این خبر یک اطلاع رسانی کاربردی درباره آب وهوا، جاده ها، ترافیک یا رفت وآمد روزانه است."
        angle = "برای کپشن، زمان، مکان و کاری که مخاطب باید انجام دهد را در اول متن بیاورید."
    elif "lifestyle" in tags:
        context = "این موضوع برای سبک زندگی دبی مناسب است؛ مثل رویداد، رستوران، مرکز خرید، پاپ آپ یا برنامه آخر هفته."
        angle = "برای کپشن، آن را به شکل پیشنهاد کوتاه برای بیرون رفتن یا تجربه جدید معرفی کنید."
    elif "viral" in tags:
        context = "این موضوع پتانسیل وایرال شدن در شبکه های اجتماعی را دارد، چون بحث برانگیز، تصویری یا قابل اشتراک گذاری است."
        angle = "برای کپشن، با یک سوال کوتاه یا جمله کنجکاوکننده شروع کنید تا کامنت بگیرد."
    elif "business" in tags:
        context = "این خبر به اقتصاد دبی، بازار ملک، سرمایه گذاری، استارتاپ ها، مشاغل یا فضای کسب وکار مربوط است."
        angle = "برای کپشن، اثر آن روی زندگی، پول یا تصمیم های روزمره مردم را ساده و قابل فهم کنید."
    else:
